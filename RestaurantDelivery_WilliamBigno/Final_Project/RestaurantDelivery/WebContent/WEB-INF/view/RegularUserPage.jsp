			...
			<div class="container-fluid">
				...
				<div id="navbar" class="navbar-collapse collapse">
					<ul class="nav navbar-nav navbar-right">
						...
						<li><a href="ListOfOrderPage">View Orders</a></li>
						<li class="active"><a href="RegularUserPage">User</a></li>
					</ul>
				</div>
			</div>
		</nav>

		<!-- User Full update processed via spring on Admin controller -->
		<div class="jumbotron">
			<div class="container">
				<div class="row">
